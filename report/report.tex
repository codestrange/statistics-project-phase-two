...
%-----------------------------------------------------------------------------------
	\bibitem{conf5} Conferencia 5 - Corelacion
	\bibitem{conf6} Conferencia 6 - Regresion Lineal Simple
	\bibitem{conf7} Conferencia 7 - Regresion Lineal Multiple
	\bibitem{conf8} Conferencia 8 - ANOVA
	\bibitem{conf9} Conferencia 9 - ACP
%-----------------------------------------------------------------------------------
\end{thebibliography}
